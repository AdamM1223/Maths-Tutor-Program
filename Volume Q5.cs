...
{
    public partial class frmVQ5 : Form
    {
        public frmVQ5()
        {
            InitializeComponent();
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
             ...
             * since this is the final Question, this will be the final Score, this result is added to the frmVQ1.results int list, which can be viewed by the users. 
            ...
            else if (rdoAnswer3.Checked == true)
            {
                ...
                MessageBox.Show("Your Scores so far: " + frmVQ1.score);
                frmVQ1.volumeResults.Add(frmVQ1.score);
                this.Hide();
            }
             ...
             * this will be the final Score, this result is added to the frmVQ1.results int list, which can be viewed by the users. This will then hide the current Form 
             */
